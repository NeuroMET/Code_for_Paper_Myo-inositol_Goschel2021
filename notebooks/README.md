...
Resting state functional MRI data which was acquired using a 7T whole-body Magnetom MRI system (Siemens Healthineers, Erlangen, Germany) was prepocessed 

using the standard preprocessing pipeline of *fMRIPrep* 20.1.1
